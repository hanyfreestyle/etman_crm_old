...
function iColorShow(i,i2){
	...
	jQuery("#"+i).css({'z-index':'9999','position':'absolute'});
...
this.izzyColor=function(){
	...
	jQuery("input.izzyColor").each(function(i){
		...
		.after('<a href="javascript:void(null)" id="icp_'+this.id+'" onclick="iColorShow(\''+this.id+'\',\'icp_'+this.id+'\')"><img src="'+imageUrl+'" style="border:0;margin:10 5 0 3px" align="absmiddle" ></a>')
