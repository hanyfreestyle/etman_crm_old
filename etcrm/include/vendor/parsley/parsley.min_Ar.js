...
! function(a) {
    ...
    d.prototype = {
            ...
            destroy: function() {
                ...
                a.emit("parsley:form:destroy", this), this.$element.removeData("Parsley")
            }
        },
        function(a) {
            var b = function(a) {
            ...
            e.prototype = {
			   ...
			   ///Hany
			   ThisURL: function() {
               return this.__class__ = "ThisURL", this.validate = function(a) {
               var c = /^http(s)?:\/\/(www\.)?[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/;
			   var x = /^#$/;
               if ( a != '#') {
					if (!c.test(a)) throw new d(this, a);
				}
    ...
    f.prototype = {
        ...
        _getErrorMessage: function(a, b) {
            ...
            return "undefined" != typeof a.options[c] ? a.options[c] : window.ParsleyValidator.getErrorMessage(b)
        },
        ...
        reset: function(b) {
            "undefined" != typeof b._ui && (b.$element.off(".Parsley"), b.$element.off(".ParsleyFailedOnce"), "ParsleyForm" !== b.__class__ && (b._ui.$errorsWrapper.children().each(function() {
                a(this).remove()
            }), this._resetClass(b), b._ui.validatedOnce = !1, b._ui.lastValidationResult = [], b._ui.validationInformationVisible = !1))
        },
        destroy: function(a) {
            "undefined" != typeof a._ui && (this.reset(a), "ParsleyForm" !== a.__class__ && (a._ui.$errorsWrapper.remove(), delete a._ui))
        },
    ...
    g.prototype = {
        ...
        getFieldOptions: function(c) {
            return this.fieldOptions = b.attr(c.$element, this.staticOptions.namespace), null === this.formOptions && "ParsleyForm" === c.parsleyInstance.__proxy__ && (this.formOptions = getFormOptions(c.parsleyInstance)), a.extend({}, this.staticOptions, this.formOptions, this.fieldOptions)
        }
    };
    var h = function(c, d) {
        if (this.__class__ = "ParsleyForm", this.__id__ = b.hash(4), "Parsley" !== b.get(d, "__class__")) throw new Error("You must give a Parsley instance");
        this.parsleyInstance = d, this.$element = a(c)
    };
    h.prototype = {
        init: function() {
            return this.validationResult = null, this.options = this.parsleyInstance.OptionsFactory.get(this), this._bindFields(), this
        },
        ...
        _bindFields: function() {
            ...
            return this.fields = [], this.fieldsMappedById = {}, this.$element.find(this.options.inputs).each(function() {
                var b = new window.Parsley(this, {}, a.parsleyInstance);
    ...
    var i = function(c, d, e, f, g) {
        ...
        j = function(c, d) {
            if (this.__class__ = "ParsleyField", this.__id__ = b.hash(4), "Parsley" !== b.get(d, "__class__")) throw new Error("You must give a Parsley instance");
            this.parsleyInstance = d, this.$element = a(c), this.options = this.parsleyInstance.OptionsFactory.get(this)
        };
    j.prototype = {
        init: function() {
            return this.constraints = [], this.constraintsByName = {}, this.validationResult = [], this.bindConstraints(), this
        },
        validate: function(b) {
        ...
        getValue: function() {
            var a;
            return a = "undefined" != typeof this.options.value ? this.options.value : this.$element.val(), !0 === this.options.trimValue ? a.replace(/^\s+|\s+$/g, "") : a
        },
        refreshConstraints: function() {
            return this.actualizeOptions().bindConstraints(), this
        },
    ...
    k.prototype = {
        ...
        getValue: function() {
            ...
            return this.$element.is("select") ? null === this.$element.val() ? [] : this.$element.val() : void 0
        }
    };
    var l = a({}),
        m = {};
    a.listen = function(a) {
        ...
        type: {
            email: "برجاء التاكد من كتابة البريد الالكترونى بصورة صحيحة",
            url: "برجاء كتابة الرابط بصورة صحيحة او كتابة #",
            number: "This value should be a valid number.",
            integer: "This value should be a valid integer.",
            digits: "هذه القيمة ارقام فقط",
    ...
    var n = function(c, d, e) {
        if (this.__class__ = "Parsley", this.__version__ = "2.0.0-rc5", this.__id__ = b.hash(4), "undefined" == typeof c) throw new Error("You must give an element");
    ...
    n.prototype = {
        init: function(a, d, e) {
            ...
            if (this.$element = a, this.$element.data("Parsley")) {
                ...
                return "undefined" != typeof e && "ParsleyField" === f.parsleyInstance.__proxy__ && (f.parsleyInstance = e), f
            }
            return this.OptionsFactory = new g(c, b.get(window, "ParsleyConfig") || {}, d, this.getNamespace(d)), this.options = this.OptionsFactory.get(this), this.$element.is("form") || b.attr(this.$element, this.options.namespace, "validate") && !this.$element.is(this.options.inputs) ? this.bind("parsleyForm", e) : this.$element.is(this.options.inputs) && !this.$element.is(this.options.excluded) ? this.isMultiple() ? this.handleMultiple(e) : this.bind("parsleyField", e) : this
        },
        isMultiple: function() {
        ...
        handleMultiple: function(c) {
            var d, e, f, g = this;
            if (this.options = a.extend(this.options, b.attr(this.$element, this.options.namespace)), this.options.multiple ? e = this.options.multiple : "undefined" != typeof this.$element.attr("name") && this.$element.attr("name").length ? e = d = this.$element.attr("name") : "undefined" != typeof this.$element.attr("id") && this.$element.attr("id").length && (e = this.$element.attr("id")), this.$element.is("select") && "undefined" != typeof this.$element.attr("multiple")) return this.bind("parsleyFieldMultiple", c, e || this.__id__);
        ...
        bind: function(c, e, f, g) {
            ...
            switch (c) {
                case "parsleyForm":
                    i = a.extend(new h(this.$element, e || this), new d, window.ParsleyExtend).init();
                    break;
                case "parsleyField":
                    i = a.extend(new j(this.$element, e || this), new d, window.ParsleyExtend).init();
                    break;
                case "parsleyFieldMultiple":
                    i = a.extend(new j(this.$element, e || this).init(), new d, new k, window.ParsleyExtend).init(f);
                    break;
                default:
                    throw new Error(c + "is not a supported Parsley type")
            }
            return "undefined" != typeof f && b.setAttr(this.$element, this.options.namespace, "multiple", f), "undefined" != typeof g ? (this.$element.data("ParsleyFieldMultiple", i), i) : (new RegExp("ParsleyF", "i").test(i.__class__) && (this.$element.data("Parsley", i), this.__proxy__ = i.__class__, a.emit("parsley:" + ("parsleyForm" === c ? "form" : "field") + ":init", i)), i)
        }
