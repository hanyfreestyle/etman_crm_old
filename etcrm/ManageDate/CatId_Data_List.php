...
if(!defined('WEB_ROOT')) {	exit;}
 echo $Fs_DataTabel ;
#$db->H_DELETE_Filte_With_Filde("config_data","cat_id","f_lead_cat");
...
$THESQL = "SELECT * FROM config_data where cat_id = '$Fs_DataTabel' $orderby ";
