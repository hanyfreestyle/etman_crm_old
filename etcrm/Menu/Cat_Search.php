...
echo '<td align="center">'.NF_PrintBut_TD('1',$AdminLangFile['sitelang_menu_sort'],"U_Postion&id=".$id,"btn-success","fa-sort-amount-desc").'</td>';
echo '<td align="center">'.NF_PrintBut_TD('1',$AdminLangFile['sitelang_cat_list_dell'],"Cat_Dell&id=".$id,"btn-danger","fa-window-close").'</td>';    
