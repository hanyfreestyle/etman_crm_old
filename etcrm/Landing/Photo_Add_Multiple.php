...
$Arr= array("Col"=> "col-md-6" ,"name"=> "filesToUpload[]" ,'required' => 'required',"upload_type"=>$ConfigP['photo_album']) ;
New_PrintFilePhoto("Multiple",$Arr);
...
if(isset($_POST['B1'])){
if($ErrForm != '1'){    
Vall($Err,"AddPhotoMultiple","landpage_photo","1",$USER_PERMATION_Add);
}  
}            
