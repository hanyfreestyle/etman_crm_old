...
$Err[] = NF_PrintInput("TextEdit",$AdminLangFile['lppage_page_name'],"name","1","1","req",$MoreS);

$MoreS = array('Col' => "col-md-4",'Placeholder'=> "",'required' => 'required' ,'Dir'=> "En_Lang");
$Err[] = NF_PrintInput("TextEdit",$AdminLangFile['lppage_page_name'].ENLANG,"name_en","1","1","req",$MoreS);
...
$MoreS = array('Col' => "col-md-6",'Placeholder'=> "",'required' => 'required' ,'Dir'=> "Ar_Lang");
$Err[] = NF_PrintInput("TextEdit",$AdminLangFile['lppage_url'],"name_m","1","1","req",$MoreS);

$MoreS = array('Col' => "col-md-6",'Placeholder'=> "",'required' => 'required' ,'Dir'=> "En_Lang");
$Err[] = NF_PrintInput("TextEdit",$AdminLangFile['lppage_url'].ENLANG,"name_m_en","1","1","req",$MoreS);

$MoreS = array('Col' => "col-md-6",'Placeholder'=> "",'required' => 'required data-parsley-maxlength="70"' ,'Dir'=> "Ar_Lang");
$Err[] = NF_PrintInput("TextEdit",$AdminLangFile['lppage_page_title'],"g_name","1","1","req",$MoreS);

$MoreS = array('Col' => "col-md-6",'Placeholder'=> "",'required' => 'required data-parsley-maxlength="70"'  ,'Dir'=> "En_Lang");
$Err[] = NF_PrintInput("TextEdit",$AdminLangFile['lppage_page_title'].ENLANG,"g_name_en","1","1","req",$MoreS);

$MoreS = array('Col' => "col-md-6",'Placeholder'=> "",'required' => 'required data-parsley-maxlength="160"' ,'Dir'=> "Ar_Lang");
$Err[] = NF_PrintInput("TextAreaEdit",$AdminLangFile['lppage_description'],"g_des","0","0","option",$MoreS);

$MoreS = array('Col' => "col-md-6",'Placeholder'=> "",'required' => 'required data-parsley-maxlength="160"'  ,'Dir'=> "En_Lang");
$Err[] = NF_PrintInput("TextAreaEdit",$AdminLangFile['lppage_description'],"g_des_en","0","0","option",$MoreS);
...
$Arr= array("Col"=> "col-md-6" ,"name"=> "photo" ,'required' => '',
"photo"=> $photo_t ,"path"=> F_PATH_V , "Dell_But"=>'1' ,'upload_type'=>$ConfigP['photo_section'] ) ;
...
if(isset($_POST['B1'])){
Vall($Err,"PageLpEdit",$db,"1",$USER_PERMATION_Edit);   
}            
